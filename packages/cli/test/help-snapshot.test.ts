...
// The changelog's claim is precise: with color off, help is BYTE-IDENTICAL to the historic plain
// text. This snapshot is the tripwire — a styling change that alters the plain rendering (a
// stray space around an interpolation, a reflowed line) fails here, not in a user's pipe.
